...
CREATE TABLE `blog_tag` (
    ...
    `created_on` datetime NOT NULL DEFAULT now() COMMENT '创建时间',
    `created_by` varchar(100) NOT NULL DEFAULT '' COMMENT '创建人',
    `modified_on` datetime NOT NULL DEFAULT now() COMMENT '修改时间',
    `modified_by` varchar(100) NOT NULL DEFAULT '' COMMENT '修改人',
    `deleted_on` datetime NOT NULL DEFAULT now() COMMENT '删除时间',
